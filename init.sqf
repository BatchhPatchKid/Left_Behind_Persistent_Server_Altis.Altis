...
missionNamespace setVariable ["FN_cookMeat", compile preprocessFileLineNumbers "Ambient\FN_cookMeat.sqf"];
missionNamespace setVariable ["FN_createFire", compile preprocessFileLineNumbers "Ambient\FN_createFire.sqf"];
missionNamespace setVariable ["FN_sanitySystem", compile preprocessFileLineNumbers "Ambient\FN_sanitySystem.sqf"];
missionNamespace setVariable ["FN_defecate", compile preprocessFileLineNumbers "Ambient\FN_defecate.sqf"];
missionNamespace setVariable ["FN_theRuns", compile preprocessFileLineNumbers "Ambient\FN_theRuns.sqf"];
...
player addEventHandler ["InventoryClosed", { [player] call FN_updateDrinkActions }];

...
if (isServer) then {
    ...
    [_faction, _trigger] spawn {
        ...
        while {true} do {
            ...
            sleep 1; // waiting for the player to have their faction update in case it isn't already
            ...
            // ——— replaced direct createGroup with helper ———
            _grpAmbush = [_side, _faction] call FN_createGroup;
            ...
            if (_vehicleBoolean) then {
                ...
                if (random 1 > _meleeChance) then {
                    ...
                    for "_i" from 0 to _numUnits do {
                        ...
                        _newAI = _grpTemp createUnit ["O_soldier_Melee_RUSH", _pos, [], 1, "NONE"];

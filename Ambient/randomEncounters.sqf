...
private _zombieTypesNATO = ["natoZombie"] call (missionNamespace getVariable "FN_arrayReturn");
...
private _ZedsSlow = ["slowZombie"] call (missionNamespace getVariable "FN_arrayReturn");
